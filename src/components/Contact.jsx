...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("access_key", "6d7dfbc9-671d-4e42-a45f-3d763514130e"); // Replace with your Web3Forms access key
 ...
 text-white min-h-screen"
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">ssanik24@gmail.com</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
    ...
    <div>
      ...
      <a
        href="https://www.linkedin.com/in/soumik-sarker-anik/"
        target="_blank"
        rel="noopener noreferrer"
        className="text-gray-400 hover:text-blue-400 transition-colors"
      >
        linkedin.com/in/soumik-sarker-anik
      </a>
    </div>
  </div>
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">St John's, NL, Canada</p>
                  </div>
                </div>
              </div>
            </div>
